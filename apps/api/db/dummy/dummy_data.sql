...
VALUES
-- cattleId=1
(1, 'ESTRUS',        1690156800000, '発情に関するメモがここに記載される'),
(1, 'INSEMINATION',  1692576000000, '人工授精に関するメモがここに記載される'),

-- cattleId=2
(2, 'CALVING',       1688083200000, '分娩に関するメモがここに記載される'),
(2, 'VACCINATION',   1692835200000, 'ワクチン接種に関するメモがここに記載される'),

-- cattleId=3
(3, 'SHIPMENT',      1703808000000, '出荷に関するメモがここに記載される'),
(3, 'HOOF_TRIMMING', 1692835200000, '削蹄に関するメモがここに記載される'),

-- cattleId=4
(4, 'ESTRUS',        1689379200000, '発情に関するメモがここに記載される'),
(4, 'OTHER',         1690156800000, 'その他に関するメモがここに記載される');
